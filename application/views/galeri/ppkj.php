...
<div class="wrapper" style="margin-top: 8vh;">
    <div class="container">
        <h2 class="text-center">Galeri PPKJ</h2>
    ...
    function loadGaleri(page) {
        ...
        if (displayData.length === 0) {
            ...
            displayData.forEach(g => {
                html += `
                <div class="gallery-card" onclick="openModal('${'<?= base_url('assets/img/galeri/ppkj/'); ?>' + g.gambar}')">
                    <img src="${'<?= base_url('assets/img/galeri/ppkj/'); ?>' + g.gambar}" alt="${g.judul}">
